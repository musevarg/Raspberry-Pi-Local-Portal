...
function initMap() {
    var map_options = {
        ...
        scrollwheel: false,
        mapMaker: true,
        styles: [{ //All roads styles
            featureType: 'road',
            elementType: 'geometry.fill',
            stylers: [{ color: '#ffffff' }, { weight: 1.9 }]
        }, { //Local roads styles
            featureType: 'road.local',
            elementType: 'geometry.fill',
            stylers: [{ color: '#f0f0f0' }, { weight: 1.4 }]
        }, { //All labels styles
            featureType: 'all',
            ...
            stylers: [{ hue: '#000000' }, { "saturation": -100 }, { "lightness": 0 }]
        }, {
    ...
    var map = new google.maps.Map(document.querySelector('.map__window'), map_options);
    var markerImage = 'images/marker.png';
    var activeMarkerImage = 'images/active_marker.png';
    var markers = {
        theatre: {
        ...
        _showInfo: function _showInfo(target) {
        ...
        setActiveMarker: function setActiveMarker() {
